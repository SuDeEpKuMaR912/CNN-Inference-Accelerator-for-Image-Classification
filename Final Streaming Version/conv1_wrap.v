...
module conv1_wrap #(
    parameter int N          = 16,
    parameter int Q          = 8,
    parameter int IMG_WIDTH  = 150,
    parameter int IMG_HEIGHT = 150,
    parameter int K          = 3,
    ...
    // ---------------------------------------------------------------
    reg c1_pulse_start_reg, c1_pulse_start;
    reg c1_pulse_w_wr_reg, c1_pulse_w_wr;
    reg c1_pulse_b_wr_reg, c1_pulse_b_wr;
    ...
    always @(posedge s_axi_aclk) begin
        if (!s_axi_aresetn) begin
            ...
            c1_pulse_start <= c1_pulse_start_reg;
            c1_pulse_w_wr  <= c1_pulse_w_wr_reg;
            c1_pulse_b_wr  <= c1_pulse_b_wr_reg;
    ...
    wire                conv_busy_w;
    wire                conv_done_w;
    wire final_start=c1_pulse_start | start_external;
