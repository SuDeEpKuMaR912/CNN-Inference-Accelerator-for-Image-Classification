...
module conv2_wrap #(
    ...
    // ---------------------------------------------------------------
    reg c2_pulse_start_reg, c2_pulse_start;
    reg c2_pulse_w_wr_reg, c2_pulse_w_wr;
    reg c2_pulse_b_wr_reg, c2_pulse_b_wr;
    ...
    always @(posedge s_axi_aclk) begin
        if (!s_axi_aresetn) begin
            ...
            c2_pulse_start <= c2_pulse_start_reg;
            c2_pulse_w_wr  <= c2_pulse_w_wr_reg;
            c2_pulse_b_wr  <= c2_pulse_b_wr_reg;
    ...
    wire                conv_busy_w;
    wire                conv_done_w;
    wire final_start=c2_pulse_start | start_external;
